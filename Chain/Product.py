...
class MajaProduct(object):
    ...
    reg_s2_ssc = r"^S2[AB]_OPER_SSC_L(1|2)VALD_\d{2}[a-zA-Z]{3}_\w+.DBL.DIR"
    ...
    reg_vs_mus = r"^VENUS-XS_[-\d]+_L(1C|2A)_\w+_\w_V\w+"
    reg_vs_nat = r"^VE_\w{4}_VSC_L[12]VALD_\w+.HDR$"
